...
@Config
@Autonomous(name = "Right15", group = "Autonomous", preselectTeleOp = "TestTeleop")
public class Right15 extends LinearOpMode {
    //INIT STEP
...
//        boolean test = determineTest();
        ...
        initialPose = (new Pose2d(70, 21, Math.toRadians(180)));
        ...
        TrajectoryActionBuilder blueCloseDrive = drive.actionBuilder(new Pose2d(-50, -50, Math.toRadians(45)))
                ...
                ;
        TrajectoryActionBuilder moveBackRightBlueFar = drive.actionBuilder(new Pose2d(70, 21, Math.toRadians(180)))
                .strafeTo(new Vector2d(70,36))
                //.stopAndAdd(new SequentialAction(hopper.getAction(),new SleepAction(1), launch.launchAction(), new SleepAction(.5), push.getLaunchSequence(),new SleepAction(.5)))
                //.stopAndAdd(launch.stopAction())
                ;
...
// Cycle through through the list and process each AprilTag.
     ...
     "{
        ...
        Action trajectoryActionChosen = null;
                trajectoryActionChosen = moveBackRightBlueFar.build();
