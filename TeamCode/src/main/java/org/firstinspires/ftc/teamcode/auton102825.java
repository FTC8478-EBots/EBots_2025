...
@Config
@Autonomous(name = "auton102825", group = "Autonomous")
public class auton102825 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Launch launch = new Launch(hardwareMap, null,telemetry,null, null);
