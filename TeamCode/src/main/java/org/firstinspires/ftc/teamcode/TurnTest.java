...
@Config
@Autonomous(name = "Turn", group = "Autonomous", preselectTeleOp = "TestTeleop")
...
//        boolean test = determineTest();
        ...
        TrajectoryActionBuilder blueCloseDrive = drive.actionBuilder(new Pose2d(-50, -50, Math.toRadians(45)))
                ...
                ;
        TrajectoryActionBuilder turn = drive.actionBuilder(new Pose2d(70, -21, Math.toRadians(180)))
...
// Cycle through through the list and process each AprilTag.
     ...
     "{
        ...
        Action trajectoryActionChosen = null;
                trajectoryActionChosen = turn.build();
